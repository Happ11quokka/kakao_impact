...
코드 작업은 주로 `2_Ulog/frontend/src/routes/HomeField.tsx` 쪽이며, 위 PNG는 디자인 산출물로 `wireframes/`에 두었습니다.
...
## 인접 파트 인터페이스
- **Frontend**: `design/deliverables/` → `2_Ulog/frontend/public/` 로 수동 복사 (빌드 스크립트 `scripts/sync-assets.sh`)
